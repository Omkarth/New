...
public class TempELectselectinon extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temp_electselectinon);
        ...
        databaseReference=db.getReference("Electrician Requested For Permanent");
        ...
        date.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog=new DatePickerDialog(TempELectselectinon.this, (view, year, monthofyeat, dayOfMonth) -> {
        ...
        perhire.setOnClickListener(v -> {
            ...
            sendata();
                   ...
                   String salute1;
                    ...
                    Intent thirdIntent = new Intent(TempELectselectinon.this, ElectricianAddress.class);
                    thirdIntent.putExtra("messafes", name);
                    thirdIntent.putExtra("dfdff", salute1);
        ...
        time.setOnClickListener(v -> {
            TimePickerDialog timePickerDialog=new TimePickerDialog(TempELectselectinon.this, (view, hourOfDay, minute) -> {
    ...
    public void sendata(){
        ...
        String datafieldtext6=txtaddress.getText().toString();
        String datafieldtext7=maid.getText().toString();

        TempElectdatabase tempElectdatabase=new TempElectdatabase(datafieldtext,datafieldtext2,datafieldtext3,datafieldtext4,datafieldtext5,datafieldtext6,datafieldtext7);
        ...
        DatabaseReference current_user=FirebaseDatabase.getInstance(Home_Page.DATABASE_URL).getReference().child("Request Pickup").child("Electrician Requested For Permanent").child(user_id);
        current_user.setValue(tempElectdatabase);

        DatabaseReference current_users=FirebaseDatabase.getInstance(Home_Page.DATABASE_URL).getReference().child("Pickup").child("Electrician Requested For Permanent").child(user_id);
        current_users.setValue(tempElectdatabase);
    }
    }
