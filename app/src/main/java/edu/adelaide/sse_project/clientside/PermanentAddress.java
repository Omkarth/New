...
public class PermanentAddress extends Activity {
    ...
    private void addHireClickListener(boolean notificationsEnabled) {
        hire.setOnClickListener(v -> {
            ...
            if (notificationsEnabled) {
                ...
                Intent intent = new Intent(PermanentAddress.this, Home_Page.class);
                PendingIntent pendingIntent = PendingIntent.getActivity(PermanentAddress.this, 0, intent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            dialog.setOnClickListener(v1 -> {
                mydialog.dismiss();
                Intent thirdIntent = new Intent(PermanentAddress.this, Home_Page.class);
                startActivity(thirdIntent);
                Toasty.success(PermanentAddress.this, "Thank you", Toast.LENGTH_SHORT).show();
            });
            mydialog.show();
