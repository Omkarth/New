...
public class PermanentMaid extends Activity {
   ...
   /*DatePicker*/TextView date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permanent_maid);
        ...
        permanent= findViewById(R.id.tvpermaid);
        ...
        m_gender.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.rb_male) gender = mgenderoption.getText().toString();
            else if (checkedId == R.id.rb_female) gender = mgenderoption.getText().toString();
        ...
        date.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog=new DatePickerDialog(PermanentMaid.this, (view, year, monthofyeat, dayOfMonth) -> {
        ...
        perhire.setOnClickListener(v -> {
            ...
            Intent dateintent=new Intent(PermanentMaid.this,PermanentAddress.class);
        ...
        time.setOnClickListener(v -> {
            TimePickerDialog timePickerDialog=new TimePickerDialog(PermanentMaid.this, (view, hourOfDay, minute) -> {
    ...
    public void sendata(){
        ...
        String datafieldtext7=permanent.getText().toString();
            MaidUser maidUser=new MaidUser(datafieldtext,datafieldtext2,datafieldtext3,datafieldtext4,datafieldtext5,datafieldtext6,datafieldtext7);
        String user_id= null;
        ...
        DatabaseReference current_user=FirebaseDatabase.getInstance(Home_Page.DATABASE_URL).getReference().child("Request Pickup").child("Maid Requested").child(user_id);
                 current_user.setValue(maidUser);
        ...
        current_users.setValue(maidUser);
    }
}
